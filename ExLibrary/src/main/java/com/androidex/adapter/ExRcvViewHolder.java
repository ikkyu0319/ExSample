 ...
 * @param <M>
 */
abstract public class ExRcvViewHolder<M> extends RecyclerView.ViewHolder {
    public ExRcvViewHolder(View itemView) {
        super(itemView);
    }

    public ExRcvViewHolder(ViewGroup parent, @LayoutRes int res) {
